...
class Home extends BaseController
{
    ...
    public function index()
    {
        ...
        // $message = "Bienvenue M/Mme " . $nom . ' ' . $prenom . "</p>
        // 				<p>Voici vos identifiants de connexion à la plateforme :</p>
        // 				<p>Login : " . $email . "</p>
        // 				<p>Mot de passe : " . $password . "</p>

        // 				<p>- Veuillez cliquer sur le lien pour accéder à la plateforme</p>

        // 				<a href='".base_url()."/' target='_blank'>Accéder à la plateforme</a>";
        ...
        //     if ($status) {
        //         var_dump( "Un mail vous été envoyé ");
        //     } else {
        //         var_dump( "Erreur ");
...
<body class='respond' leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
    ...
    <!-- end footer ====== -->
        ...
        // 				<a href='/' target='_blank'>Accéder à la plateforme</a>";
